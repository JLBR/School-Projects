...
#define DISCARD_TO_TRASH 1
#define DISCARD_TO_PLAYED 0

#define EMPTY_CARD -1
#define EMPTY_SUPPLY 0

#define NOT_BOUGHT 1
#define BOUGHT 0

#define FEAST_MAX_COST 5
#define MINE_UPGRADE_COINS 3
#define REMODEL_BONUS_COINS 2

#define ADVENTURE_TREASURE_DRAW 2
#define C_ROOM_DRAW 4
