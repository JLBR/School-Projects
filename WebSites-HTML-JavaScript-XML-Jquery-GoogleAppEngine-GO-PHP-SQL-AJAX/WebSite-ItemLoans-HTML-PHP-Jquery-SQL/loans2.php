...
<html>
	...
	<body>
		...
		<fieldset style="float:left; width:775px" data-bind="visible: loanedtome().length > 0"><legend>Items I am currently borrowing</legend>
			Click an item to view item and loan details:
			<table id="itemslist" data-bind="foreach: loanedtome">
				<tr>
					<td><a href="#" data-bind="text: name, click: loadme"></a>
					<div data-bind="visible: selected">
						<table>
							<tr><td class="fieldname">Owner:</td><td data-bind="text: owner"></td></tr>
		...
		<fieldset style="float:left; width:775px" data-bind="visible: loanedtome().length < 1"><legend>Items I am currently borrowing</legend>
